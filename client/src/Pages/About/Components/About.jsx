    ...
    return (
        <BaseLayout>
            <div className="bg-black p-28 text-white">
                <h1 className="font-bold text-left text-4xl mt-14 mb-14 text-[#54E360]">About SpootChat</h1>
                ...
                <h1 className="font-bold text-left text-4xl mt-14 mb-14 text-[#54E360]">Our mission</h1>
                ...
                <div className="flex flex-row mt-7 mb-7">
                    <div className="basis-1/3 p-7">
                        <h1 className="font-bold text-2xl mt-7 mb-7 text-[#54E360]">Sustainability</h1>
                        <p className="text-lg">Lowering emissions isn't something we do on the side. It's an integrated part of everyday business.</p>
                    </div>
                    <div className="basis-1/3 p-7">
                        <h1 className="font-bold text-2xl mt-7 mb-7 text-[#54E360]">Time to Play Fair</h1>
                    ...
                    <div className="basis-1/3 p-7">
                        <h1 className="font-bold text-2xl mt-7 mb-7 text-[#54E360]">SpootChat Loud & Clear</h1>
